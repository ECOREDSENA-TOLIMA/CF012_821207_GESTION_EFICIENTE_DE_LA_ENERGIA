  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .tarjeta.tarjeta--azul.p-4.mb-5(data-aos="fade-down")
      SlyderA(tipo="b")
        ...
        .row.justify-content-center.align-items-center
          .col-md-6.col-12.mb-4.mb-md-0
            p.mb-0 Sin embargo, es en el año 2014 cuando el Gobierno Nacional promulga la Ley 1715 de 2014 donde se especifica la necesidad para la elaboración de planes de gestión eficiente de la energía en las administraciones públicas y el fomento de la investigación en el ámbito de la gestión eficiente de la energía a nivel nacional.
          .col-md-6.col-lg-5.col-12
            figure
        ...
        .row.justify-content-center.align-items-center
          .col-md-7.col-12.mb-4.mb-md-0
            p.mb-2 Posteriormente, con la publicación por parte del Ministerio de Minas y Energía del Plan de acción indicativo de eficiencia energética 2017-2022 (PAI PROURE) se consolida el uso de los sistemas de gestión de la energía como herramienta para lograr las metas indicativas en materia energética para el país.
            h4.mb-0 Sabías que
            p.mb-2 Además de ser una herramienta para mejorar el desempeño energético de las organizaciones, la implementación de los SGEn permite la creación de empleos verdes (denominados así porque contribuyen a la sostenibilidad ambiental del planeta) y un mercado competitivo para el desarrollo de servicios energéticos y ambientales.
            h4.mb-0 Recuerda
            p Lo anterior va de la mano con la Política de crecimiento verde establecida por el Departamento Nacional de Planeación en el CONPES 3934 de 2018.
          .col-md-5.col-12
            figure
        ...
        .row.justify-content-center.align-items-center
          .col-md-6.col-12.mb-4.mb-md-0
            p.mb-0 Finalmente, con la Ley 2099 de 2021 el Gobierno Nacional establece el desarrollo de la gestión eficiente de la energía como medio para el desarrollo económico sostenible, la reducción de emisiones de gases de efecto invernadero (GEI) y la seguridad del abastecimiento energético.
          .col-md-6.col-lg-5.col-12
            figure
              img(src='@/assets/curso/temas/tema3/tema3-06.png', alt='')

    p.mb-5(data-aos="fade-down") Teniendo en cuenta todo lo que se ha informado, algunos programas implementados en Colombia para la promoción y el fortalecimiento de la gestión eficiente de la energía son:

    .tarjeta.tarjeta--azul.p-4.mb-5(data-aos="fade-down")
      SlyderA(tipo="b")
        .row.justify-content-center.align-items-center
          .col-md-6.col-12.mb-4.mb-md-0
            h4 Programa EEI Colombia
            p.mb-0 Es un proyecto realizado por el Fondo Mundial para el Medioambiente (GEF por sus siglas en inglés), la Organización de las Naciones Unidas para el Desarrollo Industrial (ONUDI) y la Unidad de Planeación Minero-Energética (UPME).
          .col-md-6.col-lg-5.col-12
            figure
